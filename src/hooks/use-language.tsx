...
const translations = {
  id: {
    ...
    'products.rahayu.desc': 'Solusi workflow untuk sektor pertanian dan agribisnis. Kelola pencatatan, monitoring, dan koordinasi tim pertanian dengan mudah.',
    ...
    'products.rodaya.desc': 'Platform workflow khusus untuk industri dan manufaktur. Optimalkan proses produksi dan kontrol kualitas.',
    'products.rodaya.features': 'Monitoring produksi real-time, Kontrol kualitas otomatis, Manajemen inventori, Laporan efisiensi',
    'products.tambakflow.desc': 'Sistem manajemen untuk budidaya perikanan dan tambak. Pantau kesehatan ikan dan kualitas air.',
    'products.tambakflow.features': 'Monitoring kualitas air, Pencatatan pakan ikan, Tracking kesehatan ikan, Laporan budidaya',
    'products.kasaflow.desc': 'Solusi retail dan toko untuk manajemen inventori dan penjualan. Kelola stok dan transaksi dengan efisien.',
    'products.kasaflow.features': 'Manajemen inventori, Tracking penjualan, Laporan keuangan, Integrasi kasir',
    'products.tamara.desc': 'WhatsApp-first Workflow untuk operasional hospitality. Sistem workflow untuk hotel non-bintang, guest house, dan villa yang terfragmentasi.',
  ...
  en: {
    ...
    'products.tambakflow.desc': 'Management system for fish farming and aquaculture. Monitor fish health and water quality.',
    'products.tambakflow.features': 'Water quality monitoring, Fish feed recording, Fish health tracking, Aquaculture reports',
