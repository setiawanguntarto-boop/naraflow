...
interface NodeConfigPanelProps {
  node: Node;
  onClose: () => void;
  onSave: (nodeId: string, title: string, description: string, metrics?: MetricDefinition[]) => void;
}
                  ...
                  <div key={index} className="border border-border rounded-lg p-3 space-y-3 bg-muted/30">
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      <div className="space-y-1">
                        <Label htmlFor={`metric-name-${index}`} className="text-xs">Name (ID)</Label>
                        <Input
                      ...
                      <div className="space-y-1">
                        <Label htmlFor={`metric-label-${index}`} className="text-xs">Display Label</Label>
                        <Input
                    ...
                    <div className="space-y-1">
                      <Label htmlFor={`metric-description-${index}`} className="text-xs">Description</Label>
                      <Textarea
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      <div className="space-y-1">
                        <Label htmlFor={`metric-type-${index}`} className="text-xs">Type</Label>
                        <select
                      ...
                      <div className="space-y-1">
                        <Label htmlFor={`metric-required-${index}`} className="text-xs">Required</Label>
                    ...
                    {metric.type === 'number' && (
                      <div className="grid grid-cols-2 gap-2">
                        <div className="space-y-1">
                          <Label htmlFor={`metric-min-${index}`} className="text-xs">Min Value</Label>
                          <Input
                            id={`metric-min-${index}`}
                            type="number"
                            value={metric.validation?.min || ''}
                            onChange={(e) => updateMetric(index, 'validation', {
                              ...metric.validation,
                        ...
                        <div className="space-y-1">
                          <Label htmlFor={`metric-max-${index}`} className="text-xs">Max Value</Label>
                          <Input
                            id={`metric-max-${index}`}
                            type="number"
                    ...
                    {metric.type === 'select' && (
                      <div className="space-y-1">
                        <Label htmlFor={`metric-options-${index}`} className="text-xs">Options (comma-separated)</Label>
                        <Input
