...
interface DeployAgentModalProps {
  ...
  initialConfig?: {
    ...
    wabaId?: string;
    environment?: string;
    // webhookUrl is auto-generated by Naraflow, not user-configured
    apiKey?: string;
  };
...
export function DeployAgentModal({ open, onOpenChange, workflow, initialConfig, onWorkflowUpdate }: DeployAgentModalProps) {
  ...
  // Auto-generate webhook URL based on agent name (provided by Naraflow)
  const generatedWebhookUrl = agentName 
    ? `https://api.naraflow.ai/webhooks/${agentName}` 
    : "";
  ...
  const handleDeploy = async () => {
    ...
    try {
      ...
      const webhookUrl = `https://api.naraflow.ai/webhooks/${agentName}`;
      ...
      const deployData: DeploymentData = {
        ...
        accessToken,
        wabaId,
        webhookUrl, // Auto-generated by Naraflow
        apiKey,
        workflow: {
      ...
      setWebhookMetrics({ verified: true, lastDeliveryAt: undefined, lastStatusCode: undefined });
        ...
        <div className="py-4 flex-1 overflow-y-auto">
          {currentStep === 1 && (
            <div className="space-y-4">
              ...
              {/* Auto-generated Webhook URL - Naraflow managed */}
              {agentName && (
                <div className="space-y-2">
                  <Label htmlFor="generatedWebhookUrl" className="text-black">Webhook URL (Auto-generated)</Label>
                  <div className="relative">
                    <Input
                      id="generatedWebhookUrl"
                      value={generatedWebhookUrl}
                      readOnly
                      className="text-black bg-gray-50 cursor-not-allowed font-mono text-xs"
                    />
                  </div>
                  <p className="text-xs text-black">
                    URL ini secara otomatis dibuat oleh Naraflow untuk menerima WhatsApp events (messages/status). 
                    Anda tidak perlu mengonfigurasinya di Meta Business.
                  </p>
                </div>
              )}
