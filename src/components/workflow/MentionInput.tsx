...
const categoryColors: Record<string, string> = {
  "Customer Service":
    "bg-blue-500 text-white dark:bg-blue-600 dark:text-white border-blue-600 dark:border-blue-400",
  "Business Process":
    "bg-emerald-600 text-white dark:bg-emerald-700 dark:text-white border-emerald-700 dark:border-emerald-500",
  "Data Processing":
    "bg-violet-600 text-white dark:bg-violet-700 dark:text-white border-violet-700 dark:border-violet-500",
  "E-commerce":
    "bg-amber-600 text-white dark:bg-amber-700 dark:text-white border-amber-700 dark:border-amber-500",
  "Content Management":
    "bg-rose-600 text-white dark:bg-rose-700 dark:text-white border-rose-700 dark:border-rose-500",
};

// Color palette for Quick Template badges - Gradient scale for better cohesion
const presetColors: Record<string, string> = {
  broiler:
    "bg-amber-500 text-white dark:bg-amber-600 dark:text-white border-amber-600 dark:border-amber-500",
  udang:
    "bg-indigo-500 text-white dark:bg-indigo-600 dark:text-white border-indigo-600 dark:border-indigo-500",
  singkong:
    "bg-pink-500 text-white dark:bg-pink-600 dark:text-white border-pink-600 dark:border-pink-500",
  sales:
    "bg-purple-500 text-white dark:bg-purple-600 dark:text-white border-purple-600 dark:border-purple-500",
  hotel: "bg-red-500 text-white dark:bg-red-600 dark:text-white border-red-600 dark:border-red-500",
  sampah:
    "bg-lime-500 text-white dark:bg-lime-600 dark:text-white border-lime-600 dark:border-lime-500",
};
  ...
  return (
    <div className="relative w-full h-full flex flex-col">
      <div
        ...
        className={
          className ||
          "flex-1 min-h-[120px] resize-none rounded-lg border border-border bg-background p-3 text-sm outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 overflow-auto"
        }
        style={{
          whiteSpace: "pre-wrap",
