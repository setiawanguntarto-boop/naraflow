  ...
  return (
    <div className="absolute top-4 left-4 bg-card border border-border rounded-xl shadow-lg p-4 z-10 w-80">
      ...
      <div className="space-y-2">
        ...
        <Button onClick={handleExportPNG} variant="outline" className="w-full justify-start">
      ...
      <div className="mt-4 p-3 bg-background rounded-lg text-xs text-foreground-muted">
        <p>
          💡 <strong>Tip:</strong> Save your workflows as JSON to preserve all data, or export as
          PNG for sharing visual previews.
        </p>
      </div>
    </div>
  );
