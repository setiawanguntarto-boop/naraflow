  ...
  return (
    <div className="relative">
      ...
      {(hasErrors || hasWarnings) && (
        <div
          className={`absolute -top-2 -left-2 w-5 h-5 rounded-full flex items-center justify-center z-10 ${hasErrors ? "bg-red-500" : "bg-yellow-500"}`}
        >
      ...
      >
        ...
        <Handle
          ...
          className="w-5 h-5 !bg-white border-2 border-brand-secondary cursor-pointer"
