...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-lg text-sm font-medium transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        primary:
          "bg-surface-primary text-surface-primary-foreground hover:bg-interactive-primary-hover shadow-soft hover:shadow-medium",
        secondary:
          "bg-surface-secondary text-surface-secondary-foreground hover:bg-surface-muted border border-border",
        hero: "bg-gradient-hero text-surface-primary-foreground hover:shadow-glow transition-all duration-500 font-semibold",
        whatsapp:
          "bg-interactive-secondary text-surface-primary-foreground hover:bg-interactive-secondary-hover shadow-soft hover:shadow-medium",
        accent:
          "bg-interactive-accent text-surface-primary-foreground hover:bg-opacity-90 shadow-soft",
