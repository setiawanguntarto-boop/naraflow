      ...
      <div className="container mx-auto px-4 sm:px-6">
        <div className="text-center mb-12">
          ...
          <p className="text-foreground-muted text-lg max-w-3xl mx-auto">
            Jelajahi fitur dan kemampuan integrasi TIPI IoT Gateway kami. Klik tombol di bawah untuk melihatnya beraksi.
          </p>
        </div>
...
function createWeighingScale() {
  ...
  const port = new THREE.Mesh(new THREE.CylinderGeometry(0.4, 0.4, 0.3, 16), new THREE.MeshStandardMaterial({ color: 0x2d3748 }));
