...
export const Hero = () => {
  ...
  const allProducts = [
    ...
    },
    {
      ...
      icon: "♻️",
      description:
        "Membantu Anda mencatat, menukar, dan melacak kontribusi daur ulang — langsung dari WhatsApp.",
      features: [],
      status: "available",
    },
  ];
  ...
  return (
    <section className="relative bg-gradient-hero overflow-hidden min-h-screen flex items-start justify-center pt-24 sm:pt-28 lg:pt-32 pb-20 lg:pb-24">
        ...
        <div className="text-center space-y-6 max-w-5xl mx-auto">
          ...
          <div className="space-y-4 animate-fade-in">
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold leading-tight tracking-tight whitespace-nowrap mt-0 mb-4">
              {t("hero.main-title-1")}{" "}
              <span className="text-brand-accent">{t("hero.main-title-wa")}</span>.{" "}
              {t("hero.main-title-2")}
            </h1>
            <p className="text-foreground-muted text-lg pt-2 max-w-3xl mx-auto italic">
              Dua kategori, satu platform. Dari farm hingga operasional lapangan — semua tercatat di
              WhatsApp.
            </p>
          </div>
          ...
          <div
            className="flex justify-center mt-8 animate-fade-in space-x-2 sm:space-x-4"
              ...
              {viewMode === "carousel" && currentProduct && (
                <div className="relative">
                  ...
                  <div
                    ...
                    style={{
                      background:
                        "linear-gradient(145deg, hsl(var(--background)) 0%, hsl(var(--background-soft)) 100%)",
                      boxShadow:
                        "12px 12px 24px rgba(0, 0, 0, 0.15), -12px -12px 24px rgba(255, 255, 255, 0.8)",
                      minHeight: "400px",
                    }}
                  >
                    <div className="text-7xl mb-6 text-center">{currentProduct.icon}</div>
                    ...
                    <div className="mt-auto pt-4 space-y-3">
                      {isAvailable ? (
                        <>
                          ...
                          {(currentProduct.name === "Rahayu" ||
                            currentProduct.name === "Tambakflow") && (
                            <a
                              href={
                                currentProduct.name === "Rahayu"
                                  ? "http://wa.me/6289637112147"
                                  : "https://wa.me/62881024280794"
                              }
                              target="_blank"
                              rel="noopener noreferrer"
